...
public class EntradaSaida {
	...
	public static int solicitaOpcao() {
		...
		String[] opcoes = { "Contruir carro(s)", "Vender carro(s)", "Ver informações do(s) carro(s)",
				"Sair do programa" };
	...
	public static int solicitaQtdeCarros(String carro) {
		...
		while(solicitaQtde<=0) {
			solicitaQtde=Integer.parseInt(JOptionPane.showInputDialog("Quantidade inválida!"
	...
	public static int solicitaAno() {
		...
		while (resultadoAno <= 0) {
			...
			resultadoAno = Integer
					.parseInt(JOptionPane.showInputDialog("Data inválida!" + "\n Digite novamente por favor!"));
		}
		return resultadoAno;
	}
